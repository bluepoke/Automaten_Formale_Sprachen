...
\newcommand{\Name}{}
\newcommand{\Seminargruppe}{5CS21-1}
\newcommand{\Uebung}{1} %  <-- UPDATE ME
\newcommand{\Uebungstitel}{Logik} %  <-- UPDATE ME
\newcommand{\Besprechungstermin}{1. November 2021}
...
%	\rhead{\sf \Semester{} \\  Seminargruppe \Seminargruppe{}}
	...
	\begin{enumerate}[a.]
		...
		\item Wenn das Messer am 1.10. im Schrank war, dann war sowohl das Messer im Schrank als auch der Hammer im Stall.
