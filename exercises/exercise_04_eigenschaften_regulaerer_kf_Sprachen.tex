...
\newcommand{\Besprechungstermin}{25.11.2024} %  <-- UPDATE ME
...
\begin{document}
	...
	\Aufgabe{4}
	Seien $L_1, L_2 \subseteq \Sigma^*$ zwei Sprachen. $L_1$ und $L=L_1 \cup L_2$ seien regulär.
	
	Es gelte $L_1 \cap L_2 = \varnothing$. Beweisen Sie: $L_2$ ist regulär.
