...
\newcommand{\Besprechungstermin}{29. November 2021} %  <-- UPDATE ME
...
\begin{document}
	...
	\Aufgabe{1}
	Zeigen Sie, dass die Sprache $L= \{z=scs \mid s \in \{a, b\}^* \}$ nicht regulär ist.
	
	\Aufgabe{2}
	Zeigen Sie, dass die Sprache $L= \{z=scs \mid s \in \{a, b\}^* \}$ nicht kontextfrei ist.
	...
	\begin{align*}
		S \rightarrow & aAb\\
		A \rightarrow & S | aaSc | \varepsilon\\
	\end{align*}
	...
	\begin{align*}
		...
		X_c \rightarrow & c\\
	\end{align*}
	Prüfen Sie mittels CYK-Algorithmus, ob das Wort $aaabbbcc$ in $L(G)$ enthalten ist.
\end{document}
